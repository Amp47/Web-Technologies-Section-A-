...
<div class="col-6 m-auto border p-5 mt-5">
    ...
    <form method="Post" action="../../Controllers/SellerPasswordRestController.php">
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label">Username</label>
            <input type="text" class="form-control" name="username" aria-describedby="emailHelp"
                   value="<?php if (isset($_SESSION['foundUser'])) {
        ...
        <?php } ?>
        <input type="submit" class="btn btn-primary mb-2" name="Update"
               value="Reset"> <br>
