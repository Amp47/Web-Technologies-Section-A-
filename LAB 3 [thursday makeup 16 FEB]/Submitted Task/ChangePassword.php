...
<head>
    ...
    <title>LAB TASK 3: Change password</title>
</head>
...
<h1 align="center">TASK Details: Designing HTML Login, <br>Change Password forms using <br>PHP with validation of user inputs</h1>
    <h2 align="center">:::Change your password safely!:::</h2><br>
    <!-- --> <!--Bootstrap Region -->
    <!-- Optional JavaScript -->
    ...
    <hr><p><span class="error">Set and Retype passwords carefully!</span></p><hr>
